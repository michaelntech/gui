...
function getState() {
  return {
    organization: AppStore.getOrganization()
  };
}
  ...
  render: function() {
    return (
      <div>
        ...
        <p>To start a virtual device, just paste the following commands (we have pasted in your specific tenant token):</p>

        <div className="code">
        <p>TENANT_TOKEN='{this.state.organization.tenant_token}'</p>
